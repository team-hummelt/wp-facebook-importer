...
class Wp_Facebook_Importer {
	...
	public function __construct() {
		if ( defined( 'WP_FACEBOOK_IMPORTER_VERSION' ) ) {
			$this->version = WP_FACEBOOK_IMPORTER_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'wp-facebook-importer';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Wp_Facebook_Importer_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Wp_Facebook_Importer_Public( $this->get_plugin_name(), $this->get_version() );
